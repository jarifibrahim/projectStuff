...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit.setGeometry(QtCore.QRect(242, 115, 1061, 401))
        self.textEdit.setObjectName(_fromUtf8("textEdit"))
        self.textEdit.setEnabled(True)
        self.textEdit.LineWrapMode = 0
        ...
        self.B_choose_file.clicked.connect(self.choose_file)
        ...
        self.B_SStart.setGeometry(QtCore.QRect(30, 25, 75, 23))
        ...
        self.B_TStart.setGeometry(QtCore.QRect(30, 30, 71, 23))
        ...
        self.B_CStart.setGeometry(QtCore.QRect(50, 20, 61, 23))
        ...
        self.B_Save.clicked.connect(self.file_save)
    ...
    def choose_file(self):
            fname = QtGui.QFileDialog.getOpenFileName(self.centralwidget, "YAST- Open Dialog")
            print(fname)
            self.lineEdit.setText(fname)

    def close_application(self):
        choice = QtGui.QMessageBox.question(self.centralwidget, 'YAST-Warning!',
                                            "Do you want to Exit?",
    ...
    def file_save(self):
        name = QtGui.QFileDialog.getSaveFileName(self.centralwidget, 'YAST-Save File')
        file = open(name,'w')
        print(name)
        file.close()
